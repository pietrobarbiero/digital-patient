...
class ClassIcpCvHelper(BaseIcpCvHelper, ClassifierMixin):
	...
	>>> from conformalgnn.icp import IcpClassifier
	>>> from conformalgnn.nc import ClassifierNc, MarginErrFunc
	>>> from conformalgnn.evaluation import ClassIcpCvHelper
	>>> from conformalgnn.evaluation import class_mean_errors
	>>> from conformalgnn.evaluation import cross_val_score
	>>> data = load_iris()
...
class RegIcpCvHelper(BaseIcpCvHelper, RegressorMixin):
	...
	>>> from conformalgnn.nc import RegressorNc, AbsErrorErrFunc
	>>> from conformalgnn.evaluation import RegIcpCvHelper
	>>> from conformalgnn.evaluation import reg_mean_errors
	>>> from conformalgnn.evaluation import cross_val_score
	>>> data = load_boston()
